...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
	...
	<div class="row <?php echo $this->params->get('presentation_style') ?>-style">
				...
				<div class="contact-form">
					<div class="section-title">
						<div class="sub-heading">
							<?php echo Jtext::_('TPL_GET_IN_TOUCH') ;?>
						</div>
		...
		<div class="col-xs-12 col-sm-5 col-lg-4 contact-information">
			<div class="inner">				
					...
					<?php if ($this->contact->name && $this->params->get('show_name')) : ?>
						<div class="section-title">
							<div class="sub-heading"><?php echo Jtext::_('TPL_CONTACT') ;?></div>
							<h2>
								<?php if ($this->item->published == 0) : ?>
									<span class="label label-warning"><?php echo JText::_('JUNPUBLISHED'); ?></span>
								<?php endif; ?>
	...
	<?php if ($this->params->get('show_articles') && $this->contact->user_id && $this->contact->articles) : ?>
		...
		<?php endif; ?>
	<?php endif; ?>
	<?php if ($this->params->get('show_profile') && $this->contact->user_id && JPluginHelper::isEnabled('user', 'profile') && ($this->params->get('presentation_style')!='plain')) : ?>
		<?php if ($this->params->get('presentation_style')=='sliders'):?>
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
