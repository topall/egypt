...
class JFormFieldCkcheckpluginversion extends JFormField {
	...
	protected $url = 'https://www.joomlack.fr/en/slideshowck/slideshow-params-plugin';

	protected $jsonurl = 'https://update.joomlack.fr/plg_slideshowckparams_update.json?callback=?';
