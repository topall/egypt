...
$FloatPostion = $params->get('floatpostion');
...
if ( $floating == 1 && $FloatPostion == 0 ){
	$CssFile = 'style_right.css';
}else if ( $floating == 0 && $newline == 0){
	$CssFile = 'style_new_line.css';
}else{
	$CssFile = 'style.css';
}


$document->addStyleSheet(JURI::base() . 'modules/mod_social_icons/tmpl/' . $CssFile );
