		...
		if ( $Social_ID != '' ){
			...
			if ( $floating != 1 ){
				...
				if ( $Network[$b]['Show'] == 1){
					...
					if ( $Network[$b]['Icon'] == 1 ){
						$toshow .= '			<div class="blank_icon img"></div>';
					}
				...
				if ( $Network[$b]['Show'] == 1){
					...
					if ( $ShowCustomVals == 1 && $ShowCustomIcon == 1 ){
						$Network_Icon = '			<img src="' . $Network[$b]['CustomIcon'] . '" width="36" height="36" />';
					}else{
						//echo '			<img src="' . $pth . strtolower( $Social_Network ) . '.png" width="36" height="36" />';
						$Network_Icon = '			<div class="' . strtolower( $Social_Network ) . '_icon">&nbsp;</div>';
					}
